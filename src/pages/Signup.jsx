...
export default function Signup() {
  ...
  const handleSubmit = async (e) => {
    ...
    // Auto-login flow — profile is created by DB trigger
      ...
      <div className="card w-full p-8">
        <div className="mb-6 text-center">
          <h1 className="text-2xl font-black">
            Join Ani<span className="text-brand">Vault</span>
          </h1>
          <p className="mt-1 text-sm text-text-secondary">
            Track, rate, and discover anime
          </p>
        </div>

        <button onClick={handleGoogle} className="btn-ghost w-full">
          <ChromeIcon className="h-4 w-4" /> Sign up with Google
        </button>
